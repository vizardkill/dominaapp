...
export declare const addMinutesToTime: (time: string, minutesToAdd: number, locale?: string) => string;
export declare const getCumulativeArray: (data: number[]) => number[];
export declare const formatTime: (minutes: number, locale?: string) => string;
export declare const formatDistance: (distance: number, locale?: string) => string;
